...
const renderCover = (deck: AIDeck, slide: AISlide, pageNumber: number): PPTistSlide => {
  const bullets = getBullets(slide, ['项目背景', '核心内容', '阶段结论']).slice(0, 3).map(item => clampText(item, 18))
  return {
    ...
    elements: [
      ...
      {
        id: `${slide.id}_cover_panel_shadow`,
        type: 'shape',
        left: 50,
        top: 48,
        width: 442,
      ...
      },
      {
        ...
        height: 20,
        rotate: 0,
        content: richParagraph(deck.topic, 12, COLORS.purple, true),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.purple,
        textType: 'header',
      },
      {
        ...
        height: 126,
        rotate: 0,
        content: richParagraph(clampText(slide.title || deck.topic, 24), getTitleSize(slide.title || deck.topic, 30), COLORS.ink, true),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.ink,
        textType: 'title',
      },
      {
        ...
        height: 24,
        rotate: 0,
        content: richParagraph(getSubtitle(slide), 14, COLORS.orange, true),
        defaultFontName: FONT_CN,
      ...
      },
      {
        ...
        height: 66,
        rotate: 0,
        content: richParagraph(getSummary(slide, '用一页封面交代主题、范围和核心信息。'), 15, COLORS.muted),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.muted,
        textType: 'content',
      },
      ...bullets.map((bullet, index) => ({
        ...
        viewBox: [200, 40],
        path: CHIP_PATH,
        fill: [COLORS.purple, COLORS.orange, COLORS.yellow][index] || COLORS.purple,
        text: {
          content: richParagraph(bullet, 11, index === 2 ? COLORS.ink : COLORS.white, true, 'center'),
          defaultFontName: FONT_CN,
          defaultColor: index === 2 ? COLORS.ink : COLORS.white,
          align: 'middle',
        },
      })),
      {
        id: `${slide.id}_photo_label`,
        type: 'shape',
        left: 774,
        top: 64,
        width: 120,
        ...
        opacity: 0.92,
        text: {
          content: richParagraph('客户 logo#', 11, COLORS.ink, true, 'center'),
          defaultFontName: FONT_CN,
          defaultColor: COLORS.ink,
          align: 'middle',
        },
  ...
  return {
    ...
    elements: [
      ...
      },
      {
        ...
        height: 22,
        rotate: 0,
        content: richParagraph('对照 A', 16, COLORS.purple, true),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.purple,
        textType: 'itemTitle',
      },
      {
        ...
        height: 22,
        rotate: 0,
        content: richParagraph('对照 B', 16, COLORS.orange, true),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.orange,
        textType: 'itemTitle',
      },
      {
        ...
        height: 92,
        rotate: 0,
        content: richParagraph(clampText(items[0] || '', 68), 15, COLORS.ink),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.ink,
        textType: 'item',
      },
      {
        ...
        height: 92,
        rotate: 0,
        content: richParagraph(clampText(items[1] || '', 68), 15, COLORS.ink),
        defaultFontName: FONT_CN,
        defaultColor: COLORS.ink,
        textType: 'item',
      },
